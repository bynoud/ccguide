...
class FlaskUI:
    ...
    def __init__(self, app=None, width=800, height=600, fullscreen=False, maximized=False, app_mode=True,  browser_path="", server="flask", host="127.0.0.1", port=5000, socketio=None, on_exit=None):
        ...
        self.last_act_time = datetime.now()
    ...
    def run(self):
        ...
        # @self.flask_app.route("/GUI-is-still-open")
        # def gui_comm():
        #     self.last_act_time = datetime.now()
        #     return "comm-ok"
    ...
    def close_server(self):
        ...
        while True:
            time.sleep(2)
            diff = datetime.now() - self.last_act_time
        ...
        #     time.sleep(2)
        #     print("Checking Gui status %s" % os.path.abspath("bo.txt"))
